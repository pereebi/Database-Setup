    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, orders.addProduct(order_id, product_id, quantity)];
            case 1:
...
var orders_routes = function (app) {
    app.get('/orders', users_1.verifyAuthToken, index);
    app.get('/orders/:id', users_1.verifyAuthToken, show);
    app.post('/orders', users_1.verifyAuthToken, create);
    app.post('/orders/:id/products', users_1.verifyAuthToken, addProduct);
};
