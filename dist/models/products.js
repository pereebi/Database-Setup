...
var AllProducts = /** @class */ (function () {
    ...
    AllProducts.prototype.index = function () {
    ...
    // create new product
    AllProducts.prototype.create = function (product) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw new Error("could not create new product ".concat(error_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    AllProducts.prototype.show = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_3 = _a.sent();
                        throw new Error("Could not find product ".concat(id, ", Error: ").concat(error_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
